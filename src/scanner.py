...
def classify_location(location):
    ...
    # Generic remote is intentionally not assumed to be India.
...
async def fetch_greenhouse_jobs(company_name, board_token):
    url = (
...
async def scan_jobs():
    ...
    for job in all_jobs:
        ...
        # Target role must be present in title.
